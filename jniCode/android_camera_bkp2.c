...
app_function (void *userdata)
{
  ...
  ahc->videscale=gst_element_factory_make ("videoscale", NULL);
  ...
  gst_element_link_many (ahc->ahcsrc, ahc->videscale, ahc->filter, ahc->vsink, NULL);
